# dmd2
dmd2 is a successor to the now-deprecated package lily-dmdata. The APIs are/will be similar but different enough to where it cannot be used as a drop-in replacement.
...
## Websocket Events
### `WebSocketEvent.WS_CONNECTED` (Not Implemented)
